...
| Claim "Hercules replication: 21/105, 18 of the paper's 19 matched" | `python3 reproduce.py rq0-repair`; per-bug record in `results/data/rq2_hercules/d4j_105_results.txt` | 21 bugs |
